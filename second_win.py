...
# ''' устанавливает, как будет выглядеть окно (надпись, размер, место) '''
    ...
    def initUI(self):
        ...
        self.line_age.setValidator(QIntValidator(7, 69420))

        self.line_test1 = QLineEdit(txt_hinttest1)
        self.line_test1.setValidator(self.validator)
        self.line_test1.setValidator(QIntValidator(0, 69420))

        self.line_test2 = QLineEdit(txt_hinttest2)
        self.line_test2.setValidator(self.validator)
        self.line_test2.setValidator(QIntValidator(0, 69420))

        self.line_test3 = QLineEdit(txt_hinttest3)
        self.line_test3.setValidator(self.validator)
        self.line_test3.setValidator(QIntValidator(0, 69420))
